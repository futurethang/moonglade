  ...
  return (
    <div className="playbill">
      ...
      <div className="cast-header">
        <h3>CAST OF CHARACTERS (in order of aerial acts)</h3>
      </div>
      ...
      <div className="credits">
        <h3>Criminal Mastermind: Jill "The Pen" Maio</h3>
        <p>Jill is the writer-director-producer of Death at Moonglade Manor, and probably the guiltiest of them all. She would like to thank a cast that was truly inspiring to work with, and an always-stellar tech crew. Special thanks to Bev Sobelman for helping to get this party started before the 2020 pandemic outbreak put it on pause, and for the renewed support this year. Thanks also to Amy Funbuttons for consulting, to Jen Ryan for making extra space, and to Kevin Hyde for his sweet design skills.</p>
      </div>
    </div>
  );
};
